...
#include "../../ThirdPart/skia/modules/svg/include/SkSVGDOM.h"
#include "../../ThirdPart/skia/modules/svg/include/SkSVGRenderContext.h"
#include "../../ThirdPart/skia/include/core/SkStream.h"
#include "../../ThirdPart/skia/include/core/SkBitmap.h"
#include "../../ThirdPart/skia/include/core/SkCanvas.h"
...
namespace NanoSvgImageLoader
{
    ...
    */
                             ...
                             bool& bDpiScaled)
    {
        ...
        nsvgPatch_setCurrentColor(ui::GlobalManager::Instance().Color().GetColor(imageLoadAttribute.svgFillColor));
        NSVGimage* svgData = nsvgParse(pData, "px", 96.0f);//传入"px"时，第三个参数dpi是不起作用的。
        if (hasAppended) {
            fileData.pop_back();
        }
                                   ...
                                   bool& bDpiScaled)
{
    ...
    case ImageFormat::kSVG:
        ...
        imageData.resize(1);
        isLoaded = NanoSvgImageLoader::LoadImageFromMemory(fileData, imageLoadAttribute,
